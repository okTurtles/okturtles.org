...
jumpToFAQ = function(faqName) {
  var $faq;
  if (faqName && ($faq = $(".faq h3[name='" + faqName + "']")).length !== 0) {
    return jumpToEl($faq);
  }
};

jumpToEl = function($id) {
  return $.scrollTo($id, {
    duration: 500,
    margin: true,
    onAfter: function() {
...
$(function() {
  ...
  tl.play();
  return jumpToFAQ(window.location.hash.slice(1));
});
